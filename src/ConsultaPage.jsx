  ...
  return (
    <div className="pagina-consulta">
      <div className="topper">
        <button className="top-button" onClick={() => window.location.reload()}>
          ← {/* <-- alterar para redirecionamento desejado */}
        </button>
        <img src={logo} alt="Logo" className="logo" />
        <div className="top-links">
          <span className="disabled-link">Usuário</span>
          <span className="disabled-link">Logout</span>
        </div>
      </div>
        ...
        <div className="tabela-linhas">
          {resultados.map((at, index) => (
            ...
            >
              ...
              <div>
                <button className="botao-editar" onClick={() => abrirPopup(at)}>
                  Editar
                </button>
              </div>
            </div>
